...
model=load_model("/home/otonom/otonom_ws/src/camera/src/tumVeriSetiyleSeritTakibiModeli.h5")
...
while True:
    ...
    ret, frame = cam.read()
    print("frame okudu")
    cv2.imwrite("/home/otonom/otonom_ws/src/camera/src/frame.jpg", frame)
    image, midpoints, yakinmi, areas, endpoints = detect_image("/home/otonom/otonom_ws/src/camera/src/frame.jpg", yakinmi)
    print("detect çalıştı")
    if aracdurdumu[0]==1:
        break
    if cagırma == 0:
    ...
    if True :
        ...
        try:
            ...
            if uzaklik_x < 0:
                ...
                pid = int(pid)
                stm.send_command(aks.Register.STEERING_ANGLE,pid)
