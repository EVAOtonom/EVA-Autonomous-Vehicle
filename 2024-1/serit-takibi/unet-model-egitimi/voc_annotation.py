...
TRAINVAL_PERCENT = 1
TRAIN_PERCENT = 0.9
DATASET_PATH = '/home/eva/Downloads/1unet/data_dataset_voc/train_voc' 
...
if __name__ == "__main__":
    ...
    seg_filepath = os.path.join(DATASET_PATH, '/home/eva/Downloads/1unet/data_dataset_voc/SegmentationClassPNG')
