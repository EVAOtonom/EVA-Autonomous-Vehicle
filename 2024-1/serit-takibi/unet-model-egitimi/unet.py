...
class UnetDataset(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        for i in range(index * self.batch_size, (index + 1) * self.batch_size):
            ...
            jpg = Image.open(
                os.path.join(os.path.join(self.dataset_path, "/home/eva/Downloads/1unet/data_dataset_voc/JPEGImages"),
                             name + ".jpg"))
            png = Image.open(
                os.path.join(
                    os.path.join(self.dataset_path, "/home/eva/Downloads/1unet/data_dataset_voc/SegmentationClassPNG"),
                    name + ".png"))
...
dataset_path = '/home/eva/Downloads/1unet/data_dataset_voc/train.voc'

# read dataset txt files
with open(os.path.join(dataset_path, "/home/eva/Downloads/1unet/data_dataset_voc/train_voc/ImageSets/Segmentation/train.txt"),
          "r",
          encoding="utf8") as f:
    train_lines = f.readlines()

with open(os.path.join(dataset_path, "/home/eva/Downloads/1unet/data_dataset_voc/train_voc/ImageSets/Segmentation/val.txt"),
          "r",
          encoding="utf8") as f:
...
checkpointCallback = ModelCheckpointCallback(
    'logs/ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.weights.h5',
    monitor='val_loss',
...
model_path = '/home/eva/Downloads/1unet/logs/the-last-model.h5'
...
test_image_path = '/home/eva/Downloads/1unet/data_annotated/sim-veri-1.png'
