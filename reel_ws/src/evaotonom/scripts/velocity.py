...
#     global brake_status, last_brake_change_time
#     brake_status = msg.data
#     last_brake_change_time = time() if brake_status else None  # Start the timer when brake is activated

# def odometer_callback(msg):
#     global previous_odom, previous_time, current_velocity
...
#     if last_brake_change_time is not None and (time() - last_brake_change_time) > 35:
#         brake_pub.publish(Bool(False))  # Deactivate brake after 35 seconds
#         last_brake_change_time = None  # Reset timer
