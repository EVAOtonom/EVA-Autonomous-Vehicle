            ...
            if detected_sign_number == 3: # DURAK KARAR ALGORITMASI
                ...
                if durak_counter < 3:
                    if current_lane == 1: # SAG SERITTEYSE
                        ...
                        while distance < durak_depth * 100 - 600 : 
                            pass
                        ...
                        brake_pub.publish(0)
                        time.sleep(2)
                        while distance < 270: # durak giriş arttı 
                            pass
                        reset_odom.publish(1)
                        time.sleep(0.5)
                        steering_pub.publish(-40)
            ...
            if detected_sign_number == 19: #kavsak icin gps bilgisi kullanarak giris yerine göre döndüren algoritma
                ...
                if kavsak_girisi == 1:
                    ...
                    if durak_counter == 2:  
                        ...
                        if current_lane == 1:
                            rospy.loginfo("@@@@@@@@@kavsak donusu basladı 2. giris sağ şerit durak çıkışına ")
                            brake_pub.publish(1)
                            time.sleep(2)
                            reset_odom.publish(1)
                            time.sleep(0.5)
