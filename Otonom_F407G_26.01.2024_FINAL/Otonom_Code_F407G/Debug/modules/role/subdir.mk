...
modules/role/%.o modules/role/%.su modules/role/%.cyclo: ../modules/role/%.c modules/role/subdir.mk
...
clean: clean-modules-2f-role

clean-modules-2f-role:
	-$(RM) ./modules/role/role.cyclo ./modules/role/role.d ./modules/role/role.o ./modules/role/role.su

.PHONY: clean-modules-2f-role
